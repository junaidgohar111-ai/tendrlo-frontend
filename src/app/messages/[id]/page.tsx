        ...
        <div className="grid md:grid-cols-3 gap-8 mt-6">
          <div className="md:col-span-2">
            ...
            <dl className="mt-6 grid grid-cols-3 gap-4 font-mono text-sm">
              <div><dt className="text-xs text-slate-500 uppercase">Budget</dt><dd className="mt-1">{formatBudget()}</dd></div>
              ...
              <div className="rounded-card border border-blueprint-100 bg-white p-6 mt-8">
                ...
                <form onSubmit={async (e) => {
                  ...
                  <div>
                    ...
                    <textarea name="proposal" required rows={4} placeholder="Describe your approach, experience, and why you are the best choice for this project..." className="mt-1 w-full rounded-card border border-blueprint-100 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blueprint-500"/>
                  </div>
                  <button type="submit" className="w-full rounded-card bg-blueprint-500 py-3 text-sm font-medium text-white hover:bg-blueprint-600 transition-colors">
                    Submit bid
                  </button>
                </form>
              </div>
