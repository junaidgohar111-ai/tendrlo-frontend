          ...
          return (
            <div key={m.id} className={'flex mb-2 ' + (isMe ? 'justify-end' : 'justify-start')}>
              <div className="max-w-[78%]">
                ...
                <div className={'rounded-2xl px-3.5 py-2.5 text-sm ' + (isMe ? 'bg-blueprint-500 text-white' : 'bg-white border border-blueprint-100 text-ink')}>
